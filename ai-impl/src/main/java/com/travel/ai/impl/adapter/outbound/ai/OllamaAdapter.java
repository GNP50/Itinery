...
public class OllamaAdapter implements AiEnrichmentPort {
    ...
    public OllamaAdapter(
            ...
            @Value("${ollama.base-url:}")         String localUrl,
        ...
        log.info("OllamaAdapter configured: mode={} baseUrl={} model={} timeoutSeconds={}",
                mode, baseUrl != null ? baseUrl : "n/a", model, timeoutSeconds);
    }
    ...
    private String callOllama(String prompt) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder(URI.create(baseUrl + GENERATE_PATH))
